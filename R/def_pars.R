...
def_pars <- function() {
  return(list(
    ...
    jHGm=1000,  # Maximum specific host growth rate (CmolH/CmolH/d)
    ...
    kNPQ=56,  # capacity of non-photochemical quenching (mol ph/CmolS/d)
    ...
    b=3  # Scaling parameter for bleaching response
  ))
}
