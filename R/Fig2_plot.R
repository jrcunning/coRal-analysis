...
png("img/Fig2.png", width=5, height=4.4, units="in", res=300)
par(mfrow=c(2,2))
imagef(gr, bin=0.01, main="A. Specific growth", col="grayscale")
imagef(sh, bin=0.1, main="B. Symbiont:host biomass", col="grayscale")
imagef(hl, bin=0.25, main="C. Host growth limitation", col=list("red","blue"))
imagef(pl, bin=0.3, main="D. Photosynthesis limitation", col=list("red", "gray30"))
dev.off()
