...
where \(j_{HGm}\) is the maximum specific growth rate. Finally, the rate
of change in coral biomass is calculated as the specific growth rate
minum the specific biomass turnover rate (i.e., maintenance costs),
according to:
...
biomass being damaged or being expelled from the holobiont). Finally,
the balance equation representing the change in symbiont biomass over
time can be specified as the growth rate minus the turnover rate:
